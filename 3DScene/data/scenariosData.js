// 3DScene/data/scenariosData.js

export const categoryColors = ["#ff595e", "#ff924c", "#ffca3a", "#8ac926", "#1982c4", "#6a4c93"];

export const categories = [
    { id: 1, name: "Seguridad Perimetral", color: categoryColors[0], icon: "Shield" },
    { id: 2, name: "Control de Acceso", color: categoryColors[1], icon: "Lock" },
    { id: 3, name: "Video Seguridad", color: categoryColors[2], icon: "Cctv" },
    { id: 4, name: "Infraestructura de Red", color: categoryColors[3], icon: "Wifi" },
    { id: 5, name: "Sistema de Alarma", color: categoryColors[4], icon: "Bell" },
    { id: 6, name: "Gestión Cloud", color: categoryColors[5], icon: "Cloud" },
];
...
export const scenarios = [
    {
        ...
        pins: [
            ...
            {
                id: "pin-conferencia",
                position: [-8, 4, 4.97], // Posición principal actualizada
                ...
                products: [
                    {
                        ...
                        position: [-8.5, 3.8, 5.0], // Distribuido alrededor de la principal
                        detail: {
                    ...
                    },
                    {
                        ...
                        position: [-7.5, 4.1, 4.8], // Distribuido alrededor de la principal
                        detail: {
                    ...
                    },
                    {
                        ...
                        position: [-8.0, 4.5, 5.2], // Distribuido alrededor de la principal
                        detail: {
