...
const HardwareElement = ({ label, children, className, tooltipSide = "top" }) => {
    ...
    return (
        <div
            ...
            onMouseEnter={() => {
                setShowTooltip(true);
                // Analytics: Exploración de características de Hardware
                trackEvent('view.help', {
                    click_chapter1: 'WonderHub',
                    click_chapter2: 'HardwareFrame',
                    click_name: 'hover_hardware_feature',
                    feature_label: label || 'unknown'
                });
            }}
                                    ...
                                    <HardwareElement label={t('hardware.power')}>
                                        <button 
                                            onClick={() => trackEvent('click.action', { 
                                                click_chapter1: 'WonderHub', 
                                                click_chapter2: 'HardwareFrame', 
                                                click_name: 'press_power_button' 
                                            })}
                                            className="w-5 h-5 rounded-full bg-gradient-to-br from-[#f3f4f6] to-[#d1d5db] shadow-sm border border-[#a1a1aa] flex items-center justify-center cursor-pointer active:scale-95 transition-transform"
                                        >
