    ...
    <div className="absolute inset-0 w-full h-full bg-[#fdfdfd] z-[1500] flex flex-col font-sans board-canvas overflow-hidden">
      ...
      {isMenuOpen && (
        ...
        >
          ...
          {[
            { label: t('board.menu.insertPicture'), icon: <ImageIcon />, demo: true },
            { label: t('board.menu.shape'), icon: <PieChart />, demo: true },
            { label: t('board.menu.flowChart'), icon: <LayoutGrid />, demo: true },
            { label: t('board.menu.stopwatch'), icon: <Clock />, demo: true },
            { label: t('board.menu.openVideo'), icon: <Video />, demo: true },
            { label: t('board.menu.table'), icon: <LayoutGrid />, demo: true },
            { label: t('board.menu.note'), icon: <FileText />, demo: true },
            {
            ...
            { label: t('board.menu.browser'), icon: <Globe />, demo: true },
            { label: t('board.menu.calculator'), icon: <Calculator />, demo: true },
            { label: t('board.menu.voting'), icon: <Check />, demo: true },
            { label: t('board.menu.lock'), icon: <Lock />, demo: true },
          ].map((item, i) => (
            <div
              key={i}
              onClick={item.action}
