...
// ... (El helper transformApiEvent y debounce se mantienen IGUAL) ...
const transformApiEvent = (apiEvent) => {
    ...
    return {
        ...
        lugar: lugar,
        direccion: direccion,
        modalidad: apiEvent.languageComplete || '', 
    };
};
...
const Calendar = ({ events, availableTabs, defaultTab }) => {
    ...
    // Efecto para actualizar tab si cambia el default (geoIP)
    ...
    const transformedEvents = useMemo(() => {
        ...
        return eventsForTab.map(transformApiEvent).filter(Boolean);
    }, [activeTab, events]);
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6 bg-white p-4 rounded-2xl border border-gray-200 shadow-sm relative z-50">
                            ...
                            <div className="relative w-full md:w-72 shrink-0 mt-1" ref={searchRef}>
                                <div className="inputGroup">
                                    ...
                                    />
                                    <label htmlFor="name">Buscar país...</label>
                                </div>
                    ...
                    {selectedDate && (
                        <div id="agenda-dia" className={`${dayViewClass}`} style={{ height: contentHeight, minHeight: 300 }}>
                            <DayView
                                ...
                                currentCountry={activeTab} // PASAMOS EL PAÍS ACTUAL
                            />
                        </div>
                    )}
                </div>
