...
${headerMsg}
🚀 ${event.titulo}
🔍 ${event.description ? event.description.substring(0, 100) + '...' : t('calendar.default_desc')}
🗓 ${event.dia} ${monthTranslated}
                ...
                <div className="flex items-start p-4 border-b border-gray-200">
                    ...
                    <div className="flex-grow">
                        <p className='text-xs font-semibold uppercase text-gray-500 tracking-wider'>
                            {event.modalidad === 'Virtual' ? t('calendar.online') : t('calendar.presencial')}
                        </p>
