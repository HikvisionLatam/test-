...
const SimpleQRModal = ({ link, title, onClose }) => {
    ...
    const handleDownload = () => {
        ...
        trackEvent('click.download', {
            ...
            click_chapter2: 'modal_qr',
            click_name: 'descargar_imagen_qr',
            qr_link: link
        });
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center backdrop-blur-sm bg-black/30 p-4" onClick={() => {
            // Analytics Tracking - Clic en backdrop
            trackEvent('click.action', {
                click_chapter1: 'calendario_eventos',
                click_chapter2: 'modal_qr',
                click_name: 'cerrar_modal_backdrop'
            });
            onClose();
        }}>
            <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full flex flex-col items-center animate-in fade-in zoom-in duration-200" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex gap-3 w-full">
                    ...
                    <button 
                        onClick={(e) => {
                            e.stopPropagation(); // Evitar doble evento con backdrop
                            // Analytics Tracking
                            trackEvent('click.action', {
                                click_chapter1: 'calendario_eventos',
                                click_chapter2: 'modal_qr',
                                click_name: 'cerrar_modal_boton'
                            });
                            onClose();
                        }}
