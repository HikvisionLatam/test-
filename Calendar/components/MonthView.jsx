        ...
        return (
            ...
            >
                ...
                {hasEvents && !isDayDisabled && (
                    <span 
                        className={`absolute ${isMobile ? '-top-2 -right-2 w-5 h-5 text-[10px]' : '-top-1 -right-1 w-4 h-4 text-[9px]'} bg-white text-gray-800 font-extrabold rounded-full flex items-center justify-center border border-gray-100 shadow-sm z-10`}
                        aria-hidden="true"
                    >
                        {eventCount}
                    </span>
