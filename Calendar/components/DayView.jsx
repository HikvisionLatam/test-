...
// --- COLORES NUEVOS PARA BADGES ---
const MODALITY_COLORS = {
    'Virtual': '#8b5cf6', // Violeta para virtual
    'Presencial': '#10b981', // Verde Esmeralda para presencial
    'default': '#6366f1'  // Indigo por defecto
};
const CITY_COLOR = '#f59e0b'; // Naranja/Amber para la ciudad
...
👉 ${event.link_registro}
    ...
    const renderCardContent = (event, isAgenda = false) => {
        ...
        // Determinar si es virtual para lógica de colores y ciudad
